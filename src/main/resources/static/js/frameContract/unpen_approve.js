...
function queryApprove(){
    ...
    var param = getParam() ;
    $.ajax({
        url:'/zall/chain/purchase/contract/inUnpen/queryApprove',
        type:'POST',
        data:param,
...
function approve(id){
    ...
    //提交
    $.ajax({
        url:"/zall/chain/purchase/contract/inUnpen/approve",
        type:'POST',
        data:param,
        success: function() {
            window.location.href="/zall/chain/purchase/contract/inUnpen/queryApproveUI";
        }
    });
}
